...
Feature: Login
  ...
  Scenario: DemoQA form interactions
    ...
    * Fill component input uploadPictureButton of PracticeForm component on the ToolsPage with text: UPLOAD-src/test/resources/files/profile-picture.jpeg
    ...
    * Verify text of listed component element Student Name from the dataRows of resultModel on the ToolsPage is equals to Umut Bora
    * Verify text of listed component element Student Email from the dataRows of resultModel on the ToolsPage is equals to umutaybora@gmail.com
    * Verify text of listed component element Gender from the dataRows of resultModel on the ToolsPage is equals to Male
    * Verify text of listed component element Mobile from the dataRows of resultModel on the ToolsPage is equals to 0655500001
    * Verify text of listed component element Date of Birth from the dataRows of resultModel on the ToolsPage is equals to 02 September,1996
    * Verify text of listed component element Subjects from the dataRows of resultModel on the ToolsPage is equals to Computer Science
    * Verify text of listed component element Hobbies from the dataRows of resultModel on the ToolsPage is equals to Music
    * Verify text of listed component element Picture from the dataRows of resultModel on the ToolsPage is equals to profile-picture.jpeg
    * Verify text of listed component element Mobile from the dataRows of resultModel on the ToolsPage is equals to 0655500001
    * Verify text of listed component element Address from the dataRows of resultModel on the ToolsPage is equals to Den Haag - Netherlands
    * Verify text of listed component element State and City from the dataRows of resultModel on the ToolsPage is equals to Haryana Karnal
